...
class Settings(object):  # pylint: disable=too-few-public-methods
    ...
    travis_autosave_final_commit = "[Results] Test of hosts"
    # Default travis commit message
    travis_autosave_commit = "[Autosave] Test of hosts"
    ...
    # Current directory.
    current_dir = '/home/travis/build/dead-hosts/hosts_git_tyzbit/'
